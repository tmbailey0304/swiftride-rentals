  ...
  return (
    <div className='flex flex-col md:flex-row w-full items-center justify-evenly px-8 lg:px-32 mt-40'>
        <div className='mb-20'>
            ...
            <h1 className=' font-extrabold text-4xl lg:text-5xl w-4/5'>Save <span className='text-orange-600 hover:scale-125 duration-500 inline-block'>big</span> with our car rental</h1>
