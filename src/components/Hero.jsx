...
const Hero = () => {
  return (
    <div className='flex flex-col md:flex-row h-screen w-full items-center justify-evenly px-8 lg:px-32'>
        <div>
            <h2 className='font-bold text-2xl'>Plan your trip now</h2>
            <h1 className=' font-extrabold text-4xl lg:text-5xl w-4/5'>Save <span className=' text-orange-600'>big</span> with our car rental</h1>
